...
class BaseDataset_cr(Dataset):
    ...
    def _load_data(self):
        ...
        for user_id in cerange:  # Use requested number of users
            for gesture_id in range(1, 7):  # Use requested number of gestures
                for ln in range(1, 6):  # Location number range
                    for on in range(1, 6):  # Orientation number range
                        for rn in range(1, 6):  # Repetition number
