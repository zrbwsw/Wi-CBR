...
def resnet18(pretrained=False, **kwargs):
    ...
    """
    # [2, 2, 2, 2] corresponds to []X2 in the structure diagram
    model = ResNet(BasicBlock, [2, 2, 2, 2], **kwargs)
    if pretrained:  # Load model weights
        pretrained_resnet18_params = torch.load('./model/Resnet18.pth')
        ...
        model.load_state_dict(pretrained_resnet18_params, strict=False)  # Load pretrained model parameters except the last layer
