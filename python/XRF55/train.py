...
from xrf55_load_data_cr3 import XRF55_BaseDataset_cr3
from xrf55_load_data_cr4 import XRF55_BaseDataset_cr4
...
def run(device, args): 
    ...
    phase_list = '../../XRF55_STIFMM'
    dfs_list = '../../XRF55_STIFMM_DFS'
    dataset_train = XRF55_BaseDataset_cr4(
    ...
    dataset_test = XRF55_BaseDataset_cr4(
        phase_list=phase_list,
        dfs_list=dfs_list,
        split_type="cr4",  
        train=False 
    ...
    with open(acc_file, "w") as f:      
        for epoch in range(0, args.Epoch):
            ...
            with torch.no_grad():
                ...
                f1_calculator = F1Calculator(num_classes=8, class_names=[
                    'Drawing circle', 'Drawing cross', 'Pushing', 'Pulling',
